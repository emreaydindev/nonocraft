package com.neilb.nonocraft.presentation.ui.views.collections.components
...
import com.neilb.nonocraft.presentation.ui.views.collections.CollectionsViewModel
import com.neilb.nonocraft.presentation.ui.views.collections.CollectionsViewModel.Companion.LIMIT
...
fun PageSelector(
    ...
    Row(
        ...
        IconButton(onClick = {
            viewModel.changePage(-1, context, isPublic)
        ...
        if (viewModel.skipNumberInLimit.value != 0) {
            ...
            Box(
                ...
                Text(text = ((viewModel.skipNumberInLimit.value!! - LIMIT) / LIMIT + 1).toString(), color = Color.White)
            }
        }
        ...
        Box(
            ...
            Text(text = ((viewModel.skipNumberInLimit.value!!) / LIMIT + 1).toString(), color = Color.White)
        }
